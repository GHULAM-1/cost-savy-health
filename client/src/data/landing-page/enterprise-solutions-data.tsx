...
export const enterpriseSolutionsData = [
  {
    icon: <PlusSquare className="text-[#8C2F5D]" size={24} color="#8C2F5D" />,
    title: "For providers.",
    description:
  ...
  {
    icon: <ShieldPlus className="text-[#8C2F5D]" size={24} color="#8C2F5D" />,
    title: "For payers.",
    description:
  ...
  {
    icon: <Building2 className="text-[#8C2F5D]" size={24} color="#8C2F5D" />,
    title: "For employers.",
    description:
  ...
  {
    icon: <Asterisk className="text-[#8C2F5D]" size={24} color="#8C2F5D" />,
