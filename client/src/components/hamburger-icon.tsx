  ...
  return (
    <label onClick={toggleMenu}>
      <div className="w-12 h-12 cursor-pointer flex flex-col items-center lg:hidden justify-center">
        <div className="w-[50%] h-[3px] bg-[#4CD7C6] rounded-sm mb-[4px]"></div>{" "}
        <div className="w-[50%] h-[3px] bg-[#4CD7C6] rounded-md mb-[4px]"></div>{" "}
        <div className="w-[50%] h-[3px] bg-[#4CD7C6] rounded-md"></div>{" "}
      </div>
    </label>
  );
}
