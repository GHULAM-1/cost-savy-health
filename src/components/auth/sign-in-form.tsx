          ...
          <div className="grid gap-4">
            ...
            <div className="grid gap-4">
              ...
              <div className="text-right flex items-center justify-center">
                <a
                  href="#"
                  className="text-xs text-teal-600 underline underline-offset-4 hover:text-teal-800"
                >
              ...
              <Button
                type="submit"
                className="w-full bg-teal-600 hover:bg-teal-700 flex items-center justify-center text-sm font-medium uppercase gap-2 h-9 cursor-pointer"
              >
                Sign In
