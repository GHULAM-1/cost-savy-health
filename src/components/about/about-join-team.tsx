...
export function JoinTeam() {
  return (
    <div className="lg:px-16 px-4">
      <div className="bg-[#1B4B43] py-16 md:py-24 px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-12 lg:gap-8">
          ...
          <div className="w-full lg:w-auto flex lg:flex lg:items-center lg:justify-end self-center">
            <a
              href="#"
              className="inline-block bg-[#B7E5DD] text-[#1B4B43] px-6 py-3 rounded-full font-medium hover:bg-[#9DD3C9] transition-colors text-center w-full lg:w-auto"
            >
              Job Openings
            </a>
          </div>
